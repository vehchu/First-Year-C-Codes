...
int main()
{
    ...
    record = populateList(record); // prompt user for employee details and populate list
    ...
    case 3:
        ...
        companyRecord *loyalList = GetLoyal(record);
        displayLoyal(loyalList);
        break;

    case 4:
        printf("Insert an employee\n");
        companyRecord *updatedRecord = InsertEmp(record);
